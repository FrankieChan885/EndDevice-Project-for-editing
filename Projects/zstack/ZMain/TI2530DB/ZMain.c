...
int main(void)
{
  ...
  HAL_BOARD_INIT();
  // Make sure supply voltage is high enough to run //check the VDD supply managemant
  zmain_vdd_check();

  // Initialize board I/O///////////////////////////////in the cold model
  InitBoard( OB_COLD );

  // Initialze HAL drivers,LCD,LED,ADC,DMA
  HalDriverInit();
