...
#define ROOM_TEMPERATURE_CHN       0x05
#define FLOOR_TEMPERATURE_CHN      0x06
...
extern uint16 HalSampleRoomTemperatureADC(void);

extern uint16 HalSampleFloorTemperatureADC(void);
