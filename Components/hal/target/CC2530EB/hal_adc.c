 ...
 * ------------------------------------------------------------------------------------------------
 */
uint16 HalReadRoomTemperature();

uint16 HalReadFloorTemperature();
...
{
#if (HAL_ADC == TRUE)
  adcRef = HAL_ADC_REF_VOLT; // use the vdd for reference
  ADCCFG |= (BV(6) + BV(5)); // for the  room temperature and the floor temperature use
#endif
}
...
/*********************************************************************
 * @fn      HalSampleRoomTemperatureADC
 *
 * @brief   read the room temperature ADC result
 *
 * @param  none
 *
 ...
 *
 *********************************************************************/
uint16 HalSampleRoomTemperatureADC(void)
{
  uint16 results = 0;
  ADCCON3 = ROOM_TEMPERATURE_CHN | HAL_ADC_DEC_512 | adcRef;
...
/*********************************************************************
 * @fn      HalSampleFloorTemperatureADC
 *
 * @brief   read the floor temperature ADC result
 *
 * @param  none
 *
 * @return  the ADC result
 ...
 *
 *********************************************************************/
uint16 HalSampleFloorTemperatureADC(void)
{
  uint16 results = 0;
  ADCCON3 = FLOOR_TEMPERATURE_CHN | HAL_ADC_DEC_512 | adcRef;
