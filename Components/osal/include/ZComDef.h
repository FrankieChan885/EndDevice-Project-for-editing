...
// 0x0401 - 0x0FFF
#define MY_DEVICEID_NV                    0x0401     //for the deviceID;
#define SET_RM_TEMP_NV                    0x0402    // for the room set temperature
#define SET_FL_TEMP_NV                    0x0403   // for the room set temperature
